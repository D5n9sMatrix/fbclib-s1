...
#Define __compiler_build_date__ Read  (ByRef  HelpCommerce As ACE_HEADER ) As ACE_HEADER
Declare Function  HelpCommerce ( ByRef  AppHelp As ACE_HEADER, ByRef  DevHelp As ACE_HEADER, ByRef  BuildHelp As ACE_HEADER ) As ACE_HEADER
