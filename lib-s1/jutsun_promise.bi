#Ifdef __FB_BUILD_DATE__
#Define __compiler_build_date__ Read  (ByRef  PromiseCommerce As ACE_HEADER ) As ACE_HEADER
Declare Function  PromiseCommerce ( ByRef  AppPromise As ACE_HEADER, ByRef  DevPromise As ACE_HEADER, ByRef  BuildPromise As ACE_HEADER ) As ACE_HEADER
...
If AppPromise.Dev Then
	Print "App dev", App
EndIf

If DevPromise.App Then
	Print "Dev app", Dev
EndIf

If BuildPromise.App Then
