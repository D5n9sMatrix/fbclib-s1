...
#Define __compiler_build_date__ Read  (ByRef  MoneyCommerce As ACE_HEADER ) As ACE_HEADER
Declare Function  MoneyCommerce ( ByRef  AppMoney As ACE_HEADER, ByRef  DevMoney As ACE_HEADER, ByRef  BuildMoney As ACE_HEADER ) As ACE_HEADER
...
If AppMoney.Dev Then
	Print "App dev", App
EndIf

If DevMoney.App Then
	Print "Dev app", Dev
EndIf

If BuildMoney.App Then
