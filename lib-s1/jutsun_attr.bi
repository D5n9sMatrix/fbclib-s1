...
#Define __compiler_build_date__ Read  (ByRef  AttrCommerce As ACE_HEADER ) As ACE_HEADER
Declare Function  AttrCommerce ( ByRef  AppAttr As ACE_HEADER, ByRef  DevAttr As ACE_HEADER, ByRef  BuildAttr As ACE_HEADER ) As ACE_HEADER
