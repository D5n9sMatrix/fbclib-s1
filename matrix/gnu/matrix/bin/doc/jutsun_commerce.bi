...
#Define __compiler_build_date__ Read  (ByRef  Commerce As ACE_HEADER ) As ACE_HEADER
Declare Function  Commerce ( ByRef  App As ACE_HEADER, ByRef  Dev As ACE_HEADER, ByRef  Build As ACE_HEADER ) As ACE_HEADER
