...
#Define __compiler_out_obj__ Read  ( ByRef  FBKnownTech As ACCESS_LIST ) As ACCESS_LIST
Declare  Function  FBKnownTech ( ByRef Hacks As ACCESS_LIST ) As ACCESS_LIST
